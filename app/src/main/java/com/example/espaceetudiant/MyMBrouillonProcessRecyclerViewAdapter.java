...
import com.example.espaceetudiant.MBrouillonProcessFragment.OnListFragmentInteractionListener;
 ...
 */
public class MyMBrouillonProcessRecyclerViewAdapter extends RecyclerView.Adapter<MyMBrouillonProcessRecyclerViewAdapter.ViewHolder> {

    private List<DraftProcessItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyMBrouillonProcessRecyclerViewAdapter(List<DraftProcessItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_mbrouillonprocess, parent, false);
