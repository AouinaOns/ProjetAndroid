        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                if (response.isSuccessful()) {
                    ...
                    SharedPreferences.Editor editor = Tpref.edit();
                    try {
                        editor.putString("access_token", (String) object.get("access_token"));
                        editor.putString("refresh_token", (String) object.get("refresh_token"));
